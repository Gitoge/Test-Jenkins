...
/**
 * REST controller for managing {@link com.sn.dtai.admin.domain.PostesNonCumulable}.
 */
@RestController
@RequestMapping("/api")
public class PostesNonCumulableResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new postesNonCumulableDTO, or with status {@code 400 (Bad Request)} if the postesNonCumulable has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/postes-non-cumulables")
    public ResponseEntity<PostesNonCumulableDTO> createPostesNonCumulable(@RequestBody PostesNonCumulableDTO postesNonCumulableDTO)
        throws URISyntaxException {
        log.debug("REST request to save PostesNonCumulable : {}", postesNonCumulableDTO);
        if (postesNonCumulableDTO.getId() != null) {
            throw new BadRequestAlertException("A new postesNonCumulable cannot already have an ID", ENTITY_NAME, "idexists");
        }
        if (postesNonCumulableDTO.getCodePoste1() == postesNonCumulableDTO.getCodePoste2()) {
            throw new BadRequestAlertException("Les deux codes ne doivent pas etre identiques", ENTITY_NAME, "Les deux codes ne doivent pas etre identiques");
        }
    ...
    /**
     * {@code PUT  /postes-non-cumulables/:id} : Updates an existing postesNonCumulable.
     *
     * @param id the id of the postesNonCumulableDTO to save.
     * @param postesNonCumulableDTO the postesNonCumulableDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated postesNonCumulableDTO,
     * or with status {@code 400 (Bad Request)} if the postesNonCumulableDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the postesNonCumulableDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<PostesNonCumulableDTO> updatePostesNonCumulable(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, postesNonCumulableDTO.getId().toString()))
            .body(result);
    }

    /**
     * {@code PATCH  /postes-non-cumulables/:id} : Partial updates given fields of an existing postesNonCumulable, field will ignore if it is null
     *
     * @param id the id of the postesNonCumulableDTO to save.
     * @param postesNonCumulableDTO the postesNonCumulableDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated postesNonCumulableDTO,
     * or with status {@code 400 (Bad Request)} if the postesNonCumulableDTO is not valid,
     * or with status {@code 404 (Not Found)} if the postesNonCumulableDTO is not found,
     * or with status {@code 500 (Internal Server Error)} if the postesNonCumulableDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/postes-non-cumulables/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<PostesNonCumulableDTO> partialUpdatePostesNonCumulable(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, postesNonCumulableDTO.getId().toString())
        );
    }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of postesNonCumulables in body.
     */
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the postesNonCumulableDTO, or with status {@code 404 (Not Found)}.
     */
    ...
    /**
     * {@code DELETE  /postes-non-cumulables/:id} : delete the "id" postesNonCumulable.
     *
