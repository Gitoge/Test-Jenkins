...
public class TypeEtablissementResource {
    ...
    public TypeEtablissementResource(TypeEtablissementRepository typeEtablissementRepository,TypeEtablissementServiceImpl typeEtablissementServiceImpl) {
    ...
    public ResponseEntity<TypeEtablissement> createTypeEtablissement(@Valid @RequestBody TypeEtablissement typeEtablissement)
        ...
        if (typeEtablissement.getCode() == null ||  typeEtablissement.getCode().trim().equals("")) {
         ...
         if (verifCodeTypeEtablissement.isPresent()) {
             throw new BadRequestAlertException("Le code '"+typeEtablissement.getCode()+"' est déjà utilisé : '"+verifCodeTypeEtablissement.get().getCode()+"'", ENTITY_NAME, "Le code '"+verifCodeTypeEtablissement.get().getCode()+"' est déjà utilisé  : '.");
         }
        }
        ...
        if (typeEtablissement.getLibelle() == null || typeEtablissement.getLibelle().trim().equals("")) {
         ...
         Optional<TypeEtablissement> verifLibelleTypeEtablissement = typeEtablissementServiceImpl.findByLibelle(typeEtablissement.getLibelle());
         if (verifLibelleTypeEtablissement.isPresent()) {
             throw new BadRequestAlertException("Le Libelle '"+verifLibelleTypeEtablissement.get().getLibelle()+"' est déjà utilisé'", ENTITY_NAME, "Le libelle '"+verifLibelleTypeEtablissement.get().getLibelle()+"' est déjà utilisé . '");
         }
        }
    ...
    public ResponseEntity<List<TypeEtablissement>> getAllTypeEtablissements(
        ...
        Page<TypeEtablissement> page = typeEtablissementRepository.findAll(pageable);
