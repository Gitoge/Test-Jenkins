...
public class PagesResource {
    ...
    public PagesResource(PagesRepository pagesRepository, PagesServiceImpl pagesServiceImpl, PagesService pagesService, PageActionService pageActionService) {
     ...
     */
    @PutMapping("/pages/{id}")
    public ResponseEntity<Pages> updatePages(
        @PathVariable(value = "id", required = false) final Long id,
        @Valid @RequestBody Pages pages
