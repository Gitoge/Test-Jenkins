...
public class EtablissementResource {
    ...
    public EtablissementResource(EtablissementRepository etablissementRepository,
            EtablissementServiceImpl etablissementServiceImpl, EtablissementMapper etablissementMapper) {
    ...
    public ResponseEntity<Etablissement> createEtablissement(@Valid @RequestBody Etablissement etablissement)
        ...
        if (etablissement.getId() != null) {
            throw new BadRequestAlertException("A new etablissement cannot already have an ID", ENTITY_NAME,
                    "idexists");
        }
        ...
        if (etablissement.getCode() == null || etablissement.getCode().trim().equals("")) {
            ...
            Optional<Etablissement> verifCodeEtablissement = etablissementServiceImpl
                    .findByCode(etablissement.getCode());
            if (verifCodeEtablissement.isPresent()) {
                throw new BadRequestAlertException(
                        "Le code '" + etablissement.getCode() + "' est déjà utilisé : '"
                                + verifCodeEtablissement.get().getCode() + "'",
                        ENTITY_NAME, "Le code '" + verifCodeEtablissement.get().getCode() + "' est déjà utilisé  : '.");
            }
        }
        ...
        if (etablissement.getLibelleCourt() == null || etablissement.getLibelleCourt().trim().equals("")) {
            ...
            Optional<Etablissement> verifLibelleEtablissement = etablissementServiceImpl
                    .findByLibelle(etablissement.getLibelleCourt());
        ...
        if(etablissement.getLibelleConvention() != null){
            ...
            ResponseEntity<ConventionDTO> responseEntityConvention = restTemplate.exchange(
                    this.applicationProperties.getRestUrlCarriere() + "/api/conventions/libelle/"
                            + etablissement.getLibelleConvention(),
                    HttpMethod.GET, entityConventionDTO, ConventionDTO.class);
    ...
    public ResponseEntity<Etablissement> updateEtablissement(
            ...
            @Valid @RequestBody Etablissement etablissement) throws URISyntaxException {
    ...
    public ResponseEntity<Etablissement> partialUpdateEtablissement(
            @PathVariable(value = "id", required = false) final Long id,
            @NotNull @RequestBody Etablissement etablissement) throws URISyntaxException {
    ...
    public ResponseEntity<List<Etablissement>> getAllEtablissementByMotsCles(
            @org.springdoc.api.annotations.ParameterObject Pageable pageable, String motCles) {
        log.debug("REST request to get a page of etablissements");
