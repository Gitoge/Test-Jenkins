    ...
    public ResponseEntity<Modules> createModules(@Valid @RequestBody Modules modules) throws URISyntaxException {
        ...
        if (modules.getCode() == null ||  modules.getCode().trim().equals("")) {
         ...
         if (verifCodeModules.isPresent()) {
             throw new BadRequestAlertException("Le code '"+modules.getCode()+"' est déjà utilisé : '"+verifCodeModules.get().getCode()+"'", ENTITY_NAME, "Le code '"+verifCodeModules.get().getCode()+"' est déjà utilisé par l'modules  : '"+verifCodeModules.get().getLibelle()+"'.");
         }
        }
        ...
        if (modules.getLibelle() == null || modules.getLibelle().trim().equals("")) {
         ...
         if (verifLibelleModules.isPresent()) {
             throw new BadRequestAlertException("Le Libelle '"+verifLibelleModules.get().getLibelle()+"' est déjà utilisé  par une module '", ENTITY_NAME, "Le libelle '"+verifLibelleModules.get().getLibelle()+"' est déjà utilisé . '");
         }
        }
