...
public class Localite implements Serializable {
    ...
    // public Localite getRattachementId() {
    //     return this.rattachementId;
    // }

    // public void setRattachementId(Localite localite) {
    //     if (this.rattachementId != null) {
    //         this.rattachementId.setLocalite(null);
    //     }
    //     if (localite != null) {
    //         localite.setLocalite(this);
    //     }
    //     this.rattachementId = localite;
    // }

    // public Localite rattachementId(Localite localite) {
    //     this.setRattachementId(localite);
    //     return this;
    // }
